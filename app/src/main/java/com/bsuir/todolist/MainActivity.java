...
import com.bsuir.todolist.adapter.NoteListAdapter;
import com.bsuir.todolist.database.AppDatabase;
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.delete:
                ...
                noteListAdapter.notifyDataSetChanged();
                Toast.makeText(MainActivity.this, "Note removed", Toast.LENGTH_LONG);
                return true;
